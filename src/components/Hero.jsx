...
export const Hero = () => {
  return (
    <div className="shadow-lg h-auto mx-auto w-full overflow-hidden bg-gradient-to-r from-[#bed7e2e8] to-[#087786ca] pt-16 sm:pt-0">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 sm:p-0">
        <div className="py-6 px-4 sm:p-10 text-center sm:text-left">
          <h1 className="text-4xl font-light sm:text-5xl sm:mb-4 text-gray-900 ">Hi! I'm Carlos Rivas Juarez,</h1>
          <p className="text-gray-700  text-xl sm:text-2xl font-bold md:text-3xl">
