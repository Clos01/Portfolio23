          ...
          <div>
            ...
            <div className="dark:text-gray-300 md:w-9/12 lg:w-11/12 xl:w-10/12 2xl:9/12 leading-normal text-gray-600 mt-5 text-xl">
              ...
              <div className="flex flex-row flex-wrap gap-2">
                <img className="w-10 h-10" src="https://cdn-icons-png.flaticon.com/512/1051/1051277.png" alt="" />
                <img className="w-10 h-10" src="https://cdn-icons-png.flaticon.com/512/919/919851.png" alt="" />
                <img className="w-10 h-10" src="https://cdn-icons-png.flaticon.com/512/2772/2772128.png" alt="" />
                <img className="w-10 h-10" src="https://cdn-icons-png.flaticon.com/512/5968/5968292.png" alt="" />
                <img className="w-10 h-10" src="https://cdn-icons-png.flaticon.com/512/919/919825.png" alt="" />
                <img className="w-10 h-10" src="https://t4.ftcdn.net/jpg/00/90/67/37/240_F_90673721_nTq4hQ0UG1RxQ1niYwMnhzp05fsdkZyN.jpg" alt="" />
              </div>
