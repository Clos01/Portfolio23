...
const Contact = () => {
  return (
    <div name='Contact' className='w-full h-screen bg-[#112646] flex justify-center items-center pt-30 sm:pt-0 p-35'>
      <form method='POST' action="https://getform.io/f/07c4747d-9e0c-4efa-8cf7-dfc955885eaa" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
          ...
          <p className='text-gray-300 py-4'> Submit the form below or shoot me an email - Cjrivas00@gmail.com</p>
        </div>
